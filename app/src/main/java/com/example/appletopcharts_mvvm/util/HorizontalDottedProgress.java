package com.example.appletopcharts_mvvm.util;
...
public class HorizontalDottedProgress extends View {
    ...
    private void createDot(Canvas canvas, Paint paint) {
        ...
        //set progress bar with 10 dots , so repeat and wnen i = mDotPosition  then increase the radius of dot i.e mBounceDotRadius
